    ...
    <div class="grid">
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <AvatarGroup class="mb-3">
                    ...
                    <Avatar :image="contextPath + 'demo/images/avatar/asiyajavayant.png'" size="large" shape="circle">
                    </Avatar>
                    <Avatar :image="contextPath + 'demo/images/avatar/onyamalimba.png'" size="large" shape="circle">
                    </Avatar>
                    <Avatar :image="contextPath + 'demo/images/avatar/ionibowcher.png'" size="large" shape="circle">
                    </Avatar>
            ...
            <div class="card">
                ...
                <ScrollPanel :style="{ width: '250px', height: '200px' }">
                    <p>
                        ...
                        et dolore magna aliqua. Vitae et leo duis ut diam. Ultricies mi quis hendrerit dolor magna eget est
                        ...
                        augue mauris. Semper feugiat nibh sed pulvinar proin gravida hendrerit lectus a. Tincidunt arcu non
                        sodales neque sodales. Metus aliquam eleifend mi in nulla posuere sollicitudin aliquam ultrices.
                        ...
                        viverra accumsan in nisl nisi. Suscipit adipiscing bibendum est ultricies integer. Mattis aliquam
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <h5>Image</h5>
                <div class="flex align-items-center flex-column sm:flex-row">
                    <Chip label="Amy Elsner" :image="contextPath + 'demo/images/avatar/amyelsner.png'" class="mr-2 mb-2">
                    </Chip>

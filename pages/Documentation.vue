            ...
            <div class="card docs">
                ...
                <p>
                    ...
                    projects. To get started, clone the <a href="https://github.com/primefaces/sakai-vue"
                        class="font-medium">repository</a> from GitHub and install the dependencies with npm or yarn.
                </p>
                ...
                <p>Next step is running the application using the serve script and navigate to <i>http://localhost:5173/</i>
                    to view the application. That is it, you may now start with the development of your application using
                    the Sakai template.</p>

                <CodeHighlight> npm run dev </CodeHighlight>

                <h5>Structure</h5>
                <p>Sakai consists of a couple folders, demos and layout have been separated so that you can easily remove
                    what is not necessary for your application.</p>
                <ul class="line-height-3">
                    <li><span class="text-primary font-medium">src/layout</span>: Main layout files, needs to be present
                    </li>
